...
var $author$project$Image$groupList = function (list) {
	if (((list.b && list.b.b) && list.b.b.b) && list.b.b.b.b) {
		...
		return A2(
			...
			$author$project$Image$groupList(rest));
	} else {
		return _List_Nil;
	}
};
var $author$project$Image$makeImage = F3(
	function (width, height, data) {
		return {
			data: A2(
				$elm$core$List$map,
				$author$project$Image$groupList,
				A2($elm_community$list_split$List$Split$chunksOfLeft, width * 4, data)),
			height: height,
			width: width
		};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Image$imageDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Image$makeImage,
	A2(
...
var $author$project$Image$jsonToImage = function (json) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Image$imageDecoder, json);
	if (_v0.$ === 'Ok') {
		var image = _v0.a;
		return image;
	} else {
...
var $author$project$Main$NewImage = function (a) {
	return {$: 'NewImage', a: a};
};
		...
		if (rs.b) {
			...
			if (fs.b) {
				...
				return A2(
					$elm$core$List$cons,
					fn(row),
					A2($author$project$Glitches$applyRowFnsToRows, fns, rows));
			} else {
				return _List_Nil;
			}
		} else {
...
var $author$project$Glitches$applyRowFnsToImage = F2(
	function (fns, img) {
...
var $author$project$Glitches$swapApply = F2(
	function (_v0, xs) {
		swapApply:
		while (true) {
			var f = _v0.a;
			...
			if (!_v1.a.b) {
				var end = _v1.b;
				var $temp$_v0 = _Utils_Tuple2(g, f),
					$temp$xs = end;
				_v0 = $temp$_v0;
				xs = $temp$xs;
				continue swapApply;
				...
				if (!_v1.b.b) {
					var start = _v1.a;
					return A2($elm$core$List$cons, start, _List_Nil);
				} else {
					var start = _v1.a;
					var end = _v1.b;
					return A2(
						...
						start,
						A2(
							$author$project$Glitches$swapApply,
							_Utils_Tuple2(g, f),
							end));
				}
			}
...
var $author$project$Glitches$breakUp = function (fn) {
	return $author$project$Glitches$swapApply(
		_Utils_Tuple2(
			$elm_community$list_extra$List$Extra$span(fn),
			$elm_community$list_extra$List$Extra$break(fn)));
};
var $author$project$Glitches$brightness = function (pixel) {
	var _v0 = _Utils_Tuple3(pixel.red, pixel.green, pixel.blue);
	var r = _v0.a;
	var g = _v0.b;
	var b = _v0.c;
	return ((r + g) + b) / 3;
...
var $author$project$Glitches$asdfRowSort = function (_break) {
	var sortFn = F2(
		function (a, b) {
			return A2(
				$elm$core$Basics$compare,
				$author$project$Glitches$brightness(a),
				$author$project$Glitches$brightness(b));
		});
	return A2(
		$elm$core$Basics$composeL,
		$elm$core$List$concatMap(
			$elm$core$List$sortWith(sortFn)),
		$author$project$Glitches$breakUp(_break));
};
