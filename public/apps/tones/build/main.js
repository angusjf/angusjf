// elm-watch hot {"version":"1.1.0","targetName":"My target name","webSocketPort":56630}
"use strict";
(() => {
...
var $author$project$Main$superInit = function (seed) {
	return _Utils_Tuple2(
		$author$project$Main$Init(seed),
...
var $author$project$Types$LowDipping = {$: 'LowDipping'};
var $author$project$Types$Rising = {$: 'Rising'};
var $author$project$Types$allTones = _List_fromArray(
	[$author$project$Types$High, $author$project$Types$Rising, $author$project$Types$LowDipping, $author$project$Types$Falling]);
var $author$project$Types$E = {$: 'E'};
var $author$project$Types$I = {$: 'I'};
var $author$project$Types$O = {$: 'O'};
var $author$project$Types$U = {$: 'U'};
var $author$project$Types$Ue = {$: 'Ue'};
var $author$project$Types$allVowels = _List_fromArray(
	[$author$project$Types$A, $author$project$Types$O, $author$project$Types$E, $author$project$Types$I, $author$project$Types$U, $author$project$Types$Ue]);
...
var $author$project$Types$uniformWithDefault = F2(
	function (x, xs) {
		if (xs.b) {
			var head = xs.a;
			var tail = xs.b;
...
var $author$project$Types$char = function (_v0) {
	var v = _v0.a;
	var t = _v0.b;
	switch (v.$) {
		case 'A':
...
var $author$project$Main$newQuestion = function (model) {
	var _v0 = A2($elm$random$Random$step, $author$project$Types$generator, model.seed);
	var answer = _v0.a;
	var seed = _v0.b;
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{answer: answer, guess: $elm$core$Maybe$Nothing, seed: seed}),
		$author$project$Main$play(answer));
};
var $author$project$Main$init = function (_int) {
	return $author$project$Main$newQuestion(
		{
			answer: _Utils_Tuple2($author$project$Types$A, $author$project$Types$High),
			guess: $elm$core$Maybe$Nothing,
			seed: $elm$random$Random$initialSeed(_int)
		});
};
...
var $author$project$Main$superUpdate = F2(
	function (msg, m) {
		switch (msg.$) {
			case 'Guess':
				var guess = msg.a;
				if (m.$ === 'Game') {
					...
					return _Utils_Tuple2(
						...
						$author$project$Main$play(guess));
				} else {
...
var $author$project$Main$debug = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				'answer: ' + $author$project$Types$char(model.answer)),
				$elm$html$Html$text(
				' / guess: ' + A2(
					$elm$core$Maybe$withDefault,
					'n/a',
					A2($elm$core$Maybe$map, $author$project$Types$char, model.guess)))
			]));
};
...
var $author$project$Main$optionData = F3(
	function (answer, guess, option) {
		return A2(
			...
			function () {
				if (guess.$ === 'Just') {
					var g = guess.a;
					return _Utils_ap(
						_Utils_eq(g, answer) ? 'correct' : 'incorrect',
						_Utils_eq(option, g) ? '-this' : '-other');
				} else {
					return 'unset';
				}
			}());
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$Guess(option)),
					A3($author$project$Main$optionData, model.answer, model.guess, option)
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
...
var $author$project$Main$viewSound = function (answer) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$PlaySound(answer))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$debug(model),
...
var $author$project$Main$viewInit = function (seed) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$NewGame(seed))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$superView = function (superModel) {
	switch (superModel.$) {
		case 'Init':
			var s = superModel.a;
			return $author$project$Main$viewInit(s);
		case 'Game':
			var model = superModel.a;
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$Main$superInit,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Main$superUpdate,
		view: $author$project$Main$superView
	});
